...
#+last_modified: [2022-04-20 Ср 11:53]

* Исходники                                                        :noexport:
  :PROPERTIES:
  :CREATED:               [2022-04-20 Ср 09:07]
  :HASH:                  -689672546680233886
  :LAST_MODIFIED:         [2022-04-20 Ср 11:14]
  :END:
...
* То, что будет в статье
  ...
  :HASH:                  -179187886445121314
  :LAST_MODIFIED:         [2022-04-20 Ср 11:34]
  :END:

#+name: main-1-result
#+begin_src python :exports results :results file graphics :file "static/sigma_phi.png" :noweb yes 
  <<defs>>
...
#+name: main-2-result
#+begin_src python :exports results :results file graphics :file "static/d_1-2.png" :noweb yes 
  <<defs>>
...
#+name: main-3-result
#+begin_src python :exports results :results file graphics :file "static/F_k_0.png" :noweb yes 
  <<defs>>
...
#+name: main-4-result
#+begin_src python :exports results :results file graphics :file "static/delta_F_k_0.png" :noweb yes 
  <<defs>>
...
#+name: main-5-result
#+begin_src python :exports results :results file graphics :file "static/F_k.png" :noweb yes 
  <<defs>>
...
#+name: main-6-result
#+begin_src python :exports results :results file graphics :file "static/F_k-F_k_0.png" :noweb yes 
  <<defs>>
